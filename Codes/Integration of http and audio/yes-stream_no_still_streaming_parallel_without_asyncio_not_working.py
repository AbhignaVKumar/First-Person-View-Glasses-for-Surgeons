import sensor#concurrent without asyncio
import time #yes detected starts streaming, when no is heard still continues to stream
import network #concurrent without asyncio not woeking
import socket
import audio
import tf
import micro_speech
